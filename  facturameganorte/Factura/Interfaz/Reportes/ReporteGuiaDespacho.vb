...
Public Class ReporteGuiaDespacho
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteGuiaDespacho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteGuiaDespacho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteGuiaDespacho = New ReporteGuiaDespacho
        rpt.Site = Me.Site
        Return rpt
    End Function
