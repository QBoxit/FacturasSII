...
Partial Public Class DataNotaCredito
    ...
    Partial Public Class DataTableDatosDataTable
        ...
        Public Overloads Function AddDataTableDatosRow( _
                    ...
                    ByVal Ncedible As String,  _
                    ByVal Detalle As String) As DataTableDatosRow
            Dim rowDataTableDatosRow As DataTableDatosRow = CType(Me.NewRow,DataTableDatosRow)
            Dim columnValuesArray() As Object = New Object() {NumeroNC, Nombre, Direccion, Giro, Rut, Comuna, Telefono, FacturaNum, FechaDia, FechaMes, FechaAÑo, Vendedor, OrdenCompra, ValorLetras, Total, Neto, Iva, Ncedible, Detalle}
    ...
    Partial Public Class DataTableDatosRow
        ...
        Public Property Detalle() As String
            Get
                Try 
                    Return CType(Me(Me.tableDataTableDatos.DetalleColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Detalle' in table 'DataTableDatos' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableDataTableDatos.DetalleColumn) = value
            End Set
        End Property
        ...
        Public Function IsDetalleNull() As Boolean
            Return Me.IsNull(Me.tableDataTableDatos.DetalleColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetDetalleNull()
            Me(Me.tableDataTableDatos.DetalleColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
