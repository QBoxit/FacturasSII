...
Partial Public Class DataNotaCredito
    ...
    Partial Public Class DataTableDatosDataTable
        ...
        Public Overloads Function AddDataTableDatosRow( _
                    ...
                    ByVal Iva As String) As DataTableDatosRow
            Dim rowDataTableDatosRow As DataTableDatosRow = CType(Me.NewRow,DataTableDatosRow)
            Dim columnValuesArray() As Object = New Object() {NumeroNC, Nombre, Direccion, Giro, Rut, Comuna, Telefono, FacturaNum, FechaDia, FechaMes, FechaAÑo, Vendedor, OrdenCompra, ValorLetras, Total, Neto, Iva}
