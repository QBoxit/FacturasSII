...
Partial Public Class DataSetFactura
    ...
    Partial Public Class DataTableDatosFactDataTable
        ...
        Public Overloads Function AddDataTableDatosFactRow( _
                    ...
                    ByVal ColumnTotalNumero As String) As DataTableDatosFactRow
            Dim rowDataTableDatosFactRow As DataTableDatosFactRow = CType(Me.NewRow,DataTableDatosFactRow)
            Dim columnValuesArray() As Object = New Object() {ColumnNombre, ColumnDireccion, ColumnGiro, ColumnRut, ColumnComuna, ColumnTelefono, ColumnNumeroFactura, ColumnGuiaDespacho, ColumnOrdenCompra, ColumnCondVenta, ColumnNeto, ColumnIva, ColumnTotal, ColumnDia, ColumnMes, ColumnAño, ColumnVendedor, ColumnTotalNumero}
